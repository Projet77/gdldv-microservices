            ...
            <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-6 flex gap-3">
                        <button className="flex-1 bg-black text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-800 transition-colors">
                            Détails
                        </button>
                        {status === 'ACTIVE' && (
                            <button className="flex-1 bg-yellow-400 text-black px-4 py-2 rounded-lg text-sm font-bold hover:bg-yellow-300 transition-colors">
                                Prolonger
                            </button>
                        )}
                    </div>
