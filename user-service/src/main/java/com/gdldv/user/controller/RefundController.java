...
public class RefundController {
    ...
    @Operation(summary = "Obtenir la politique de refund", description = "Calculer le pourcentage de remboursement basé sur le temps restant")
    ...
    @Operation(summary = "Traiter un remboursement", description = "Calculer et traiter le remboursement via Stripe")
    ...
    @Operation(summary = "Demander un remboursement", description = "Créer une demande de remboursement en attente d'approbation admin")
