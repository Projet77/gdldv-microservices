...
public class ClientController {
    ...
    @Operation(summary = "Tableau de bord client",
            description = "Obtenir toutes les informations du dashboard client (réservations, favoris, historique, etc.)")
    ...
    @Operation(summary = "Réservations actives",
            description = "Obtenir les réservations en cours du client")
    @PreAuthorize("hasRole('CLIENT') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Historique des locations",
            description = "Obtenir l'historique complet des locations du client")
    @PreAuthorize("hasRole('CLIENT') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Véhicules favoris",
            description = "Obtenir la liste des véhicules favoris du client")
    @PreAuthorize("hasRole('CLIENT') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Statistiques personnelles",
            description = "Obtenir les statistiques du client (total dépensé, nombre de locations, etc.)")
    @PreAuthorize("hasRole('CLIENT') or hasRole('ADMIN')")
