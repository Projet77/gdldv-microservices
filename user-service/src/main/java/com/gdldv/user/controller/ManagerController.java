...
public class ManagerController {
    ...
    @Operation(summary = "Tableau de bord manager",
            description = "Obtenir toutes les informations du dashboard manager (KPIs, équipe, tendances, etc.)")
     ...
     */
    @GetMapping("/kpis")
    @Operation(summary = "KPIs du jour",
            description = "Obtenir les indicateurs clés de performance du jour")
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Performance de l'équipe",
            description = "Obtenir les statistiques de performance du staff")
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Incidents critiques",
            description = "Obtenir la liste des incidents critiques")
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Tendances",
            description = "Obtenir les tendances de revenus, locations et satisfaction (30 derniers jours)")
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
    ...
    @Operation(summary = "Top performers",
            description = "Obtenir les meilleurs véhicules et clients")
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
    ...
    @Operation(summary = "État de la flotte",
            description = "Obtenir le statut de la flotte de véhicules")
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
