...
public class AdminController {
    ...
    @Operation(summary = "Tableau de bord administrateur", description = "Obtenir les statistiques et tâches urgentes")
    ...
    @Operation(summary = "Approuver un remboursement", description = "Approuver manuellement un remboursement en attente")
    ...
    @Operation(summary = "Envoyer un rappel au client", description = "Envoyer un email/SMS de rappel au client pour une réservation")
    @PreAuthorize("hasRole('ADMIN') or hasRole('EMPLOYEE')")
