...
public class SuperAdminDashboardService {
    ...
    private SuperAdminDashboard.DatabaseStatistics getDatabaseStatistics() {
        ...
        String status = diskUsagePercentage < 50 ? "OK" :
                       diskUsagePercentage < 80 ? "WARNING" : "CRITICAL";
    ...
    private SuperAdminDashboard.SystemConfiguration getSystemConfiguration() {
        SuperAdminDashboard.SystemConfiguration.PaymentConfig paymentConfig =
                SuperAdminDashboard.SystemConfiguration.PaymentConfig.builder()
                        .provider("STRIPE")
                        .currency("XOF")
                        .active(true)
                        .webhooksActive(true)
        ...
        SuperAdminDashboard.SystemConfiguration.EmailConfig emailConfig =
                SuperAdminDashboard.SystemConfiguration.EmailConfig.builder()
        ...
        SuperAdminDashboard.SystemConfiguration.SecurityConfig securityConfig =
                SuperAdminDashboard.SystemConfiguration.SecurityConfig.builder()
                        .sslEnabled(true)
                        .jwtConfigured(true)
