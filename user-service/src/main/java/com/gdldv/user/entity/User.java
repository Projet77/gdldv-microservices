...
public class User implements UserDetails {
    ...
    public User(Long id, String firstName, String lastName, String email, String password, String phoneNumber,
            String address, String city, String postalCode, String country, String drivingLicenseNumber,
            String drivingLicenseCountry, LocalDate drivingLicenseExpiryDate, boolean active, boolean emailVerified,
            LocalDateTime lastLoginAt, LocalDateTime createdAt, LocalDateTime updatedAt, Set<Role> roles) {
        this.id = id;
